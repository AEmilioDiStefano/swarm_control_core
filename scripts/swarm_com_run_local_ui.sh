...
export SWARM_COM_IMAGE_THUMB_INTEREST_TTL_S="${SWARM_COM_IMAGE_THUMB_INTEREST_TTL_S:-0.75}"
export SWARM_COM_THUMB_ROBOTS_PER_TICK="${SWARM_COM_THUMB_ROBOTS_PER_TICK:-0}"
...
if ! [[ "${SWARM_COM_THUMB_ROBOTS_PER_TICK}" =~ ^-?[0-9]+$ ]]; then
  log "Invalid SWARM_COM_THUMB_ROBOTS_PER_TICK='${SWARM_COM_THUMB_ROBOTS_PER_TICK}', forcing 0."
